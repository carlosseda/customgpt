module.exports = (app) => {
  ...
  const controller = require('../controllers/admin/assistant-customer-controller.js')

  router.get('/get-assistants', [authCookie.verifyUserCookie], controller.getAssistants)
  ...
  app.use('/api/admin/assistant-customers', router)
}
